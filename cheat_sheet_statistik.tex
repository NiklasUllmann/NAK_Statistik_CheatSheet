...
\begin{landscape}
    ...
    \begin{center}
        \begin{tabular}{lll}
            Test\textbackslash{}Realität & $H_0$ richtig                           & $H_1$ richtig       \\
            $H_0$ behalten                  & \multicolumn{1}{l|}{ok (Spezifität)} & $\beta$ Fehler      \\ \cline{2-3} 
            $H_0$ verwerfen                 & \multicolumn{1}{l|}{$\alpha$ Fehler}    & ok (Sisitivität)
            \end{tabular}
    \end{center}
